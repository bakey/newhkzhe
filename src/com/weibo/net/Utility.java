...
public class Utility {
    ...
    private static final HashMap<String,String> m_month_map = new HashMap<String,String>() {
    	{
    		put("Jan" , "01" );
    		put("Feb" , "02" );
    		put("Mar" , "03" );
    ...
    public static HttpClient getNewHttpClient(Context context) {
        try {
            ...
            if (!wifiManager.isWifiEnabled()) {
                // 闁兼儳鍢茶ぐ鍥亹閹惧啿顤呮慨婵撶到濠�亝鎷呯捄銊︽殢闁汇劌鍤圥N闁规亽鍎遍崣鍡涙倷閿燂拷              
            	Uri uri = Uri.parse("content://telephony/carriers/preferapn");
                Cursor mCursor = context.getContentResolver().query(uri, null, null, null, null);
                if (mCursor != null && mCursor.moveToFirst()) {
                    // 婵炴挸鎲￠悥锝囩矓閺勫繐娈剧紒妤婂厸缁旀挳寮堕檱椤斿洩銇愰弴顏嗙鐟滅増鎸鹃崝褎绋婇悢宄版锭闁哄牆顦虹粩鎾级閿燂拷             
    ...
    public static String MonthToIntStr( String mon ) {
    	if ( m_month_map.containsKey( mon) ) {
    		return m_month_map.get( mon );
    	}else {
    		return "";
    	}
