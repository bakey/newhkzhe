...
public class URLs implements Serializable {
	...
	public final static String WEIBO_API_HOST = "api.weibo.com";
	...
	public final static String WEIBO_ACCESS_TOKEN_URL = HTTPS + WEIBO_API_HOST + "/oauth2/access_token";	
	public final static String WEIBO_GET_USER_URL     = HTTPS + WEIBO_API_HOST + "/2/users/show.json";
	
	public final static String LATEST_THREAD_API_PATH = "hotel" + URL_SPLITTER + "index.php/site/LatestThreadList";
	public final static String DISCOUNT_ACTIVITIES_API_PATH = "hotel" + URL_SPLITTER + "index.php/site/GetDiscountList";	
	public final static String RANK_THREAD_API_PATH = "hotel" + URL_SPLITTER + "index.php/site/RankThreadList";	
	public final static String THREAD_DETAIL_PATH = "hotel" + URL_SPLITTER + "index.php/site/ThreadDetail";
	
	private final static String URL_API_HOST = HTTP + API_HOST + URL_SPLITTER;
	public final static String LOGIN_NOTIFY_URL = HTTP + API_HOST + URL_SPLITTER + "hotel/index.php/user/NotifyLogin";
	...
	public final static String LATEST_THREADS_LIST = HTTP + API_HOST + URL_SPLITTER + LATEST_THREAD_API_PATH ;
	public final static String DISCOUNT_ACTIVITIES_LIST = HTTP + API_HOST + URL_SPLITTER + DISCOUNT_ACTIVITIES_API_PATH ;
	public final static String RANK_THREADS_LIST = HTTP + API_HOST + URL_SPLITTER + RANK_THREAD_API_PATH ;  
	...
	public final static String SAVE_FAVORITE_RSC = HTTP + API_HOST + URL_SPLITTER + "hotel/index.php/user/SaveMyFavorite";
	public final static String ELIMINATE_FAVORITE_RSC = HTTP + API_HOST + URL_SPLITTER + "hotel/index.php/user/EliminateMyFavorite";
	public final static String GET_FAVORITE_RSC = HTTP + API_HOST + URL_SPLITTER + "hotel/index.php/user/GetMyFavorite";
	...
	public final static String COMMENT_LIST = URL_API_HOST+"hotel/index.php/site/CommentList";
